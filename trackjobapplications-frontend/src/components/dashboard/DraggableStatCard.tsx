...
export default memo(function DraggableStatCard({
  ...
  return (
    <div
      ...
      className={`cursor-grab active:cursor-grabbing transition-all outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 rounded-lg ${
