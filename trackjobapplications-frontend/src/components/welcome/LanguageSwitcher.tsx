  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        aria-expanded={open}
        aria-haspopup="menu"
        className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-200 hover:bg-stone-100 dark:hover:bg-stone-800 transition-all duration-150"
      ...
      >
        ...
        <span className="text-xs font-semibold text-stone-700 dark:text-stone-300">{current.code.toUpperCase()}</span>
        <svg
      ...
      {open && (
        <div role="menu" className="absolute right-0 mt-1.5 w-40 bg-white dark:bg-stone-800 rounded-lg shadow-lg border border-stone-100 dark:border-stone-700 py-1 z-50">
