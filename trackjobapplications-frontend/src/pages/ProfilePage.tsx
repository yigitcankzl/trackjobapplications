  ...
  return (
    <DashboardLayout>
      ...
      <div className="max-w-2xl mx-auto space-y-8 pb-12">
        ...
        <div className="relative bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 space-y-5 overflow-hidden">
          {/* Coming Soon overlay */}
          <div className="absolute inset-0 bg-white/70 dark:bg-gray-900/70 backdrop-blur-[2px] rounded-2xl z-10 flex flex-col items-center justify-center gap-1.5">
            ...
            <div className="flex gap-2">
              {[1, 6, 24, 48].map((hours) => (
                <button
                  ...
                  type="button"
                  disabled
                  className="px-3 py-1.5 text-xs font-medium rounded-lg border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400"
                >
